...
type Shipment struct {
	...
	DSTPort      *string
	NumberOfPkgs int
	Consignee    Consignee `gorm:"foreignKey:Num"`
	Shipper      Shipper   `gorm:"foreignKey:Num"`
	Invoice      Invoice   `gorm:"foreignKey:Num"`
}
...
type Invoice struct {
	Num      int     `gorm:"primaryKey;column:INVOICE_NAME"`
